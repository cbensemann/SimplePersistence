...
public @interface Transaction {
    ...
    public enum TxType {
        /**
         * <p>
         * If called outside a transaction context, the interceptor must begin a new JTA transaction, the managed bean method execution must then
         * continue inside this transaction context, and the transaction must be completed by the interceptor.
         * </p>
         * <p>
         ...
         * </p>
         * <p>
         * If called inside a transaction context, the current transaction context must be suspended, a new JTA transaction will begin, the managed
         * bean method execution must then continue inside this transaction context, the transaction must be completed, and the previously suspended
         ...
         * </p>
         * <p>
         * If called inside a transaction context, the current transaction context must be suspended, the managed bean method execution must then
         * continue outside a transaction context, and the previously suspended transaction must be resumed by the interceptor that suspended it after
         * the method execution has completed.
         * </p>
         */
        NOT_SUPPORTED,
